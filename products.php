...
require('connect.php');
$pid = $_GET['productID'];
$productquery = "SELECT pname FROM `product` where pid='$pid'";
	...
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			...
			<div class="w3ls_w3l_banner_nav_right_grid">
				...
				<h3><?php while($prod = mysql_fetch_array($product)){ echo $prod['pname'];}?></h3>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href=""><img src="images/<?php echo $row['iimg']?>" alt=" " class="img-responsive" /></a>
